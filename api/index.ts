...
app.get('/cap_nhi_tan_2025', function (req, res) {
    res.sendFile(path.join(__dirname, "..", 'views', 'cap_nhi_tan_2025.html'));
});
app.get('/con_duong_to_lua_2025', function (req, res) {
    res.sendFile(path.join(__dirname, "..", 'views', 'con_duong_to_lua_2025.html'));
});
app.get('/duong_tau_thanh_tang_2025', function (req, res) {
    res.sendFile(path.join(__dirname, "..", 'views', 'duong_tau_thanh_tang_2025.html'));
});
app.get('/thai_binh_co_tran_2025', function (req, res) {
    res.sendFile(path.join(__dirname, "..", 'views', 'thai_binh_co_tran_2025.html'));
});
